...
`}</style>
                    ...
                    <section className="chapters-section" id="chapters">
                        ...
                        <div className="chapter-block" id="ch-1">
                            <div className={`chapter-head ${openChapterId === 'ch-1' ? 'open' : ''}`} onClick={() => toggleChapter('ch-1', 1)}>
                                ...
                                <div className="ch-head-content">
                                    <div className="ch-title"> CEACAM5 Biology and Its Role in the Success of Precision Medicine</div>
                                </div>
                        ...
                        <div className="chapter-block" id="ch-2">
                            <div className={`chapter-head ${openChapterId === 'ch-2' ? 'open' : ''}`} onClick={() => toggleChapter('ch-2', 2)}>
                                ...
                                <div className="ch-head-content">
                                    <div className="ch-title">CEACAM5 Precision Therapy – Ten Year Leadership will have to be
                                        Designed</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                        ...
                        <div className="chapter-block" id="ch-3">
                            <div className={`chapter-head ${openChapterId === 'ch-3' ? 'open' : ''}`} onClick={() => toggleChapter('ch-3', 3)}>
                                ...
                                <div className="ch-head-content">
                                    <div className="ch-title">Clinical Development as a Competitive Frontier in CEACAM5</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            </div>
                        ...
                        <div className="chapter-block" id="ch-4">
                            <div className={`chapter-head ${openChapterId === 'ch-4' ? 'open' : ''}`} onClick={() => toggleChapter('ch-4', 4)}>
                                ...
                                <div className="ch-head-content">
                                    <div className="ch-title">CEACAM5: Competitor Analysis</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            </div>
                        ...
                        <div className="chapter-block" id="ch-5">
                            <div className={`chapter-head ${openChapterId === 'ch-5' ? 'open' : ''}`} onClick={() => toggleChapter('ch-5', 5)}>
                                ...
                                <div className="ch-head-content">
                                    <div className="ch-title">ADC Architecture Decisions and Clinical Development Strategy</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            </div>
                        ...
                        <div className="chapter-block" id="ch-6">
                            <div className={`chapter-head ${openChapterId === 'ch-6' ? 'open' : ''}`} onClick={() => toggleChapter('ch-6', 6)}>
                                ...
                                <div className="ch-head-content">
                                    <div className="ch-title">Antibodies Differentiation, Due Diligence and Applications</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            </div>
                        ...
                        <div className="chapter-block" id="ch-7">
                            <div className={`chapter-head ${openChapterId === 'ch-7' ? 'open' : ''}`} onClick={() => toggleChapter('ch-7', 7)}>
                                ...
                                <div className="ch-head-content">
                                    <div className="ch-title">Payload, Implications for Clinical Development and Leadership</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            </div>
 ...
 <div className="chapter-block" id="ch-8">
                            <div className={`chapter-head ${openChapterId === 'ch-8' ? 'open' : ''}`} onClick={() => toggleChapter('ch-8', 8)}>
                                ...
                                <div className="ch-head-content">
                                    <div className="ch-title">Linkers: IP, Trial Planning and Licensing</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            </div>
                        ...
                        <div className="chapter-block" id="ch-9">
                            <div className={`chapter-head ${openChapterId === 'ch-8' ? 'open' : ''}`} onClick={() => toggleChapter('ch-8', 8)}>
                                <div className="ch-num">09</div>
                                <div className="ch-head-content">
                                    <div className="ch-title">Companion Diagnostics : From Enabler to Determinant of Long Term
                                        Leadership</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            ...
                            <div className={`chapter-body ${openChapterId === 'ch-8' ? 'open' : ''}`}>
                                ...
                                {/* Summary strip — ch-8 */}
                                {localStorage.getItem('token') && hasSummary(9) && (
                                    <div className="summary-strip">
                                        <button
                                            className={`btn-summary ${openSummaryId === 'summary-8' ? 'active' : ''}`}
                                            onClick={() => toggleSummary(8)}
                        ...
                        <div className="chapter-block" id="ch-10">
                            <div className={`chapter-head ${openChapterId === 'ch-8' ? 'open' : ''}`} onClick={() => toggleChapter('ch-8', 8)}>
                                <div className="ch-num">10</div>
                                <div className="ch-head-content">
                                    <div className="ch-title">Standard of Care, Line Extension Strategy and its Impact on Leadership</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            </div>
                        ...
                        <div className="chapter-block" id="ch-11">
                            <div className={`chapter-head ${openChapterId === 'ch-8' ? 'open' : ''}`} onClick={() => toggleChapter('ch-8', 8)}>
                                <div className="ch-num">11</div>
                                <div className="ch-head-content">
                                    <div className="ch-title">Valuation of CEACAM5 Assets in Parallel with Clinical Development</div>
                                </div>
                                <div className="ch-price"><span>or included in full</span></div>
                                <div className="ch-toggle">+</div>
                            </div>
