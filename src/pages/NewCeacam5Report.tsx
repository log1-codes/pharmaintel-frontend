...
`}</style>
            <div className="report-container">
                ...
                <div className="content-wrap">
                    ...
                    {/* PDF above Executive Summary (num == 0) */}
                                    ...
                                    {loadingSummary[summary.id] ? (
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                                            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                                <a href={summaryUrls[summary.id]} download={`${summary.title.replace(/[^a-z0-9]/gi, '_').toLowerCase()}.pdf`} style={{ padding: '8px 16px', backgroundColor: 'var(--accent)', color: 'white', borderRadius: '4px', textDecoration: 'none', fontSize: '13px', fontWeight: 'bold' }}>
                                                    ↓ Download PDF
                                                </a>
                                            </div>
                    ...
                    {/* Preface PDF below Executive Summary text (num == -1) */}
